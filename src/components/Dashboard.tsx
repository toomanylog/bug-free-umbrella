...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, buttons, type = 'info' }) => {
...
const Dashboard: React.FC<DashboardProps> = ({ onClose }) => {
  ...
  const handleBuyFormation = async (formation: any) => {
    ...
    try {
      ...
      if (result.paymentUrl) {
        ...
        // Rafraîchir les formations de l'utilisateur
        const loadUserFormations = async () => {
          if (!currentUser) return;
        ...
        showNotification(
          'Achat réussi', 
          `Vous avez acquis la formation "${formation.title}" avec succès. Elle est maintenant disponible dans "Mes formations".`,
          'success'
        );
      }
    } catch (error: any) {
  ...
  const handleFormationAction = (formation: any) => {
                        ...
                        >
                          ...
                          <div className="p-4 flex-1 flex flex-col">
                            ...
                            <div className="flex justify-between items-center mt-auto">
                              ...
                              <button 
                                onClick={() => handleFormationAction(formation)}
