    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (crashStatsSnapshot.exists()) {
          setCrashStats(crashStatsSnapshot.val());
        }
      } catch (error) {
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold mb-2">Profits/Pertes</h3>
            <div className="flex items-center justify-between">
              <span className={`text-3xl font-bold ${crashStats.profitLoss >= 0 ? 'text-green-500' : 'text-red-500'}`}>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold">{crashStats.totalGames}</span>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold">{crashStats.totalWagered.toFixed(2)} €</span>
